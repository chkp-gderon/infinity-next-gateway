...
variable "waapAgentFog" {
  description = "Fog address (optional)"
  type = string
}

variable "template_name"{
  description = "Template name. Should be defined according to deployment type(ha, vmss, waap_vmss)"
  type = string
  default = "waap_vmss"
}
...
locals { // locals for 'backend_load_distribution' allowed values
...
variable "vm_os_offer" {
  description = "The name of the offer of the image that you want to deploy.Choose from: check-point-cg-r8030, check-point-cg-r8040, check-point-cg-r81, infinity-gw"
  type = string
}
